...
CREATE TABLE recipe_ingredients (
    ...
    ingredient_total_calories   NUMBER
);
...
CREATE TABLE recipes (
    ...
    cost                    NUMBER,
    servings                NUMBER(2),
    cook_time               INTERVAL DAY(1) TO SECOND(0),
...
ALTER TABLE recipe_ingredients
    ADD CONSTRAINT ri_i_fk FOREIGN KEY ( ingredient_id )
        REFERENCES ingredients ( ingredient_id );

ALTER TABLE recipe_ingredients
    ADD CONSTRAINT ri_r_fk FOREIGN KEY ( recipe_id )
        REFERENCES recipes ( recipe_id );
...
CREATE SEQUENCE ingredients_ingredient_id_seq START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER ingredients_ingredient_id_trg BEFORE
    INSERT ON ingredients
    FOR EACH ROW
    WHEN ( new.ingredient_id IS NULL )
BEGIN
    :new.ingredient_id := ingredients_ingredient_id_seq.nextval;
END;
/
